...
const sidebarItems = [
  ...
  { id: "backstory", label: "Backstory", Icon: History },
...
export default function KaleidoColorLabLayout({
  ...
  return (
    <div className="flex w-full items-start">
      {/* Desktop sidebar — sticky inside its column so it never overlaps the footer */}
      {desktopOpen && (
      ...
      <div className="flex-1 min-w-0">
        {/* Trigger bar — visible on all breakpoints */}
        <div className="sticky top-16 z-40 flex items-center gap-2 bg-white/80 backdrop-blur-md px-4 py-2 border-b border-zinc-100">
          ...
          <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <SheetContent side="left" className="w-64 p-0 flex flex-col">
              <VisuallyHidden.Root>
                <SheetTitle>Kaleido Colorlab navigation</SheetTitle>
                <SheetDescription>
                  Section navigation for the Kaleido Colorlab case study.
                </SheetDescription>
              </VisuallyHidden.Root>
              <div className="border-b border-zinc-200 px-4 py-4">
                <HeaderTitle />
