  ...
  return (
    <div className="bg-white text-black">
      <div className="relative">
          ...
          <section
            id="introduction"
            className="relative py-20 bg-white overflow-hidden scroll-mt-20"
          >
          ...
          <section
            id="overview"
            className="w-full py-24 bg-[#F8F4EF] relative overflow-hidden scroll-mt-20"
          >
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mb-10">
                ...
                <div className="ml-9 mb-8 space-y-2">
                  <p className="text-base text-zinc-500">
                    1. Users see a color in the real world but don&apos;t know
                    how to replicate and mix it.
                  </p>
                  <p className="text-base text-zinc-500">
              ...
              <div>
                ...
                <div className="ml-9 mb-6">
                  <p className="text-base text-zinc-500">
                    A color app that lets users purchase the colors they truly
                    need.
                  </p>
                </div>
                <Image
              ...
              <div className="space-y-32">
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="w-full space-y-6">
                    ...
                    <p className="text-base text-zinc-500 leading-relaxed">
                      Solution: Instant color extraction that recommends the
                      closest matching color or a custom mixing recipe.
                    </p>
                    <p className="text-base text-zinc-500 leading-relaxed">
                      Beta Update: Always-On Magnifier in Color Picker; Let
                      users choose the color codes (HEX, RGB, HSL)
                    </p>
                  </div>
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="w-full space-y-6">
                    <p className="text-base text-zinc-500 leading-relaxed">
                      Pain Point: Fear of wasting expensive colors on failed
                      mixing attempts.
                    </p>
                    <p className="text-base text-zinc-500 leading-relaxed">
                      Solution: A digital sandbox to test ratios before physical
                      execution. Users combine colors, adjust ratios in
                      real-time, and preview results.
                    </p>
                    <p className="text-base text-zinc-500 leading-relaxed">
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="w-full space-y-6">
                    ...
                    <p className="text-base text-zinc-500 leading-relaxed">
                      Solution: A dashboard lets admins update color
                      collections, manage mixing formulas, track user
                      preferences and purchase behavior with filters by region
                      and time.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-16">
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="w-full space-y-6">
                    ...
                    <p className="text-base text-zinc-500 leading-relaxed">
                      Solution: I designed a personal color note feature that
                      lets users document real-world mixing ratios and
                      techniques, turning a screen accuracy limitation into a
                      user personal color library.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section id="leadership" className="w-full py-24">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mb-12 bg-[#F8F4EF] border-2 border-zinc-200 rounded-2xl p-10 relative">
                <ul className="space-y-3 list-disc list-inside text-zinc-500 text-base leading-relaxed">
              ...
              <div className="mb-12">
                ...
                <p className="text-base text-zinc-500 leading-relaxed ml-10 mb-6">
                  We can leverage existing color tech with our product to lead
                  the industry.
                </p>
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="bg-white rounded-xl border-2 border-zinc-200 overflow-hidden">
                    ...
                    <div className="p-6 text-center">
                      ...
                      <p className="text-base text-zinc-500 leading-relaxed">
                        ...
                        technology is proven — we&apos;re not starting from
                        zero.
                      </p>
                    </div>
                  </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-base text-zinc-500 leading-relaxed ml-10 mb-8">
                  ...
                  to prove the technical feasibility.
                </p>
              ...
              <div className="bg-[#F8F4EF] border-l-4 border-black rounded-r-2xl p-6 mb-16">
                ...
                <ul className="space-y-2 list-disc list-inside text-base text-zinc-500 leading-relaxed">
                  <li>
                    Through the marketing analysis and my MVP, stakeholders
                    realized that designing and developing an app wasn&apos;t as
              ...
              <div className="mb-12">
                ...
                <p className="text-base text-zinc-500 leading-relaxed ml-10 mb-4">
                  ...
                  &apos;Let&apos;s Talk&apos; video to test users&apos; feedback
                  for a color mixer.
                </p>
                <div>
                  <div className="relative w-full aspect-video rounded-2xl overflow-hidden border-2 border-zinc-300">
              ...
              <div className="text-center mb-14">
                <div className="mt-8">
                  <div
                    className="relative group cursor-zoom-in rounded-2xl overflow-hidden border-2 border-zinc-200 bg-white"
                    onClick={() =>
                      setZoomedImage("/kaleidocolorlab/feedback.webp")
                    }
                  >
                    <Image
          ...
          <section
            id="reflections"
            className="w-full bg-[#F8F4EF] relative overflow-hidden scroll-mt-20"
          >
